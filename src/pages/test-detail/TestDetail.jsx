    ...
    <div className="test-detail">
      ...
      <div className="tabs-switch-cont">
        ...
        <div onClick={() => switcherFun("leaderboard")}>
          <p className={tabs === "leaderboard" ? "active" : ""}>Leaderboard</p>
          <div className={`bar ${tabs === "leaderboard" ? "baractive" : ""}`} />
        </div>
        <hr />
        <div onClick={() => switcherFun("examDetails")}>
          <p className={tabs === "examDetails" ? "active" : ""}>Exam Details</p>
          <div className={`bar ${tabs === "examDetails" ? "baractive" : ""}`} />
        </div>
        <hr />
        <div onClick={() => switcherFun("pointSystem")}>
          <p className={tabs === "pointSystem" ? "active" : ""}>Point System</p>
          <div className={`bar ${tabs === "pointSystem" ? "baractive" : ""}`} />
        </div>
      </div>
      {tabs === "cashPrize" ? (
